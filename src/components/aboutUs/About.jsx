...
export default function About() {
    return (
        <section className="px-3 h-screen w-full">
            <div className="max-sm:px-6 w-full rounded-[35px] h-full bg-center bg-cover flex justify-center items-center mt-25" style={{backgroundImage: `url(${AboutImg})`}}>
