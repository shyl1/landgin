...
export default function WebHosting() {
    return (
        <section className="w-full h-[70vh] sm:h-screen px-3 my-20 md:my-35">
            <div className="w-full h-full rounded-[35px] flex flex-col pt-10 md:pt-25 items-center relative overflow-hidden" style={{background:" radial-gradient(50% 50% at 50% 50%, #345D86 0%, #1C344C 100%" }}>
